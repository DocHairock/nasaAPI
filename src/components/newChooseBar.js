...
const NewChooseBar =()=> {
 ...
 const componentDidMount=()=>{
  ...
  <div className="rovers">   
              ...
              ></img>
              <input onChange={onChange()} checked={state.value==="curiosity"}  type="radio" id="curiosity" name="value" value="curiosity" ></input>
          <label htmlFor="curiosity">curiosity</label>
             <CameraMenu/>
              ...
              ></img>
              <input onChange={onChange()} checked={state.value==="opportunity"}  type="radio" id="opportunity" name="value" value="opportunity" ></input>
          <label htmlFor="opportunity">opportunity</label>
              ...
              ></img>
              <input onChange={onChange()} checked={state.value==="spirit"}  type="radio" id="spirit" name="value" value="spirit" ></input>
